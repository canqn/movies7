...
<template>
  ...
  >
    <div class="m__poster rounded-md max-w-[230px] mb:max-w-none tb:max-w-none">
      <img
        :src="movie.poster_url"
        alt=""
        class="img__poster w-full rounded-lg object-cover mb:absolute mb:opacity-10 tb:absolute tb:h-full tb:opacity-10"
      />
    </div>
